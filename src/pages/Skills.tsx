...
const SkillsList: Record<string, SkillItem[]> = {
    'Programming Languages': [
        ...
        { img_path: '/assets/images/logos/cuda-svgrepo-com.svg', title: 'CUDA', ref_link: 'https://developer.nvidia.com/cuda/toolkit' },
        { img_path: '/assets/images/logos/fortran-svgrepo-com.svg', title: 'Fortran', ref_link: 'https://fortran-lang.org/' },
...
function Skills() {
    ...
    return (
        <div className='skills'>
                        ...
                        <div className='skills-group' key={index}>
                            ...
                            <div className='skills-grid'>
                                {SkillsList[group].map((skill) => {
                                    ...
                                    return (
                                        <div className={`skill-wrapper ${isLast ? 'always-show' : ''}`} key={skill.title}>
                                            <SkillCard
            ...
            <FontAwesomeIcon
                className={`icon-button ${currentSection >= groups.length - 1 ? 'disabled' : ''}`}
